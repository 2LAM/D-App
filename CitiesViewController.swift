...
class CitiesViewController: UITableViewController, CLLocationManagerDelegate, WeatherDelegate {
...
//        self.saveToFile()
        ...
        if (CLLocationManager.authorizationStatus() == .authorizedWhenInUse ||
            ...
            cityLocation = weatherInfo.getCityID(self.currentLocation.coordinate.latitude, self.currentLocation.coordinate.longitude)
    ...
    private func loadFromFile() {
     ...
     private func saveCurrentCity(_ city: City) {
