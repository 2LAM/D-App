...
class CitySearchViewController: UITableViewController {
    ...
    var chosenCity = WeatherViewController.City(cityID: "", name: "")
    ...
    override func viewDidLoad() {
        ...
        URL = documentsDirectory.appendingPathComponent("city.list").appendingPathExtension("json")
        checkFile()
        dispatchGroup.enter()
    ...
    func loadFromFile() {
        if let cityData = try? Data(contentsOf: URL) {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        chosenCity = WeatherViewController.City(cityID: String(filteredCities[indexPath.row].id), name: filteredCities[indexPath.row].name)
